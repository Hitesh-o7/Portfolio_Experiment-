...
export default function SoulscanProjectPage() {
      ...
      <section className="max-w-full mx-auto -mt-[15%] px-4 sm:px-[8%] md:px-[12%] lg:px-[15%] py-8 sm:py-[10%] md:py-[15%] lg:py-[20%]">
        <div className="flex flex-col gap-4 h-full">
          <div className="flex flex-col gap-4 h-full justify-center items-center mb-10 relative max-md:mt-10">
            <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl xl:text-8xl 2xl:text-9xl text-black font-bold mb-[-1rem] sm:mb-[-1.5rem] md:mb-[-2rem] lg:mb-[-2.5rem] max-md:mt-8 relative z-0">
              SoulScan
            </h1>
            <p className="mt-6 text-center max-w-2xl text-gray-700 text-sm sm:text-base md:text-lg">
              SaaS web platform focused on LinkedIn outreach, automating messaging workflows so users can scale
              personalized conversations without losing control.
            </p>
            <div className="w-full bg-gray-100 rounded-lg overflow-hidden relative z-10 mt-6">
              {!imageLoaded && (
              ...
              <Image
                ...
                alt="SoulScan SaaS LinkedIn automation platform"
                width={1920}
                height={1080}
